        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-3 items-center py-2">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <span class="uppercase font-bold text-2xl">System Admin Dashboard</span>
                </div>

                <!-- CENTER LOGO -->
                <div class="flex justify-center">
                    <router-link to="/SysAdminDashboard" class="flex flex-col items-center">
...
const menuItems = [
    ...
    { label: "Manage Branch", icon: "pi pi-building", to: "/ManageBranch" },
    { label: "Manage Promo Codes", icon: "pi pi-ticket", to: "/ManagePromoCodes" },
    { label: "Manage Shoes", icon: "pi pi-shopping-bag", to: "/ManageShoes" },
    { label: "View Logs", icon: "pi pi-history", to: "/ViewLogs" },
];
</script>
