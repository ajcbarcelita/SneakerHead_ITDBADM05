...
export const getBranches = async (req, res) => {
  try {
    ...
    const branches = await knex("branches")
      ...
      .leftJoin(
        "ref_ph_cities_municipalities",
        "addresses.city_id",
        "ref_ph_cities_municipalities.city_id",
      )
      .orderBy("branches.branch_id", "asc");
...
export const addBranch = async (req, res) => {
  try {
    const { branch_name, addressline1, addressline2, city_id } = req.body;
...
export const addUser = async (req, res) => {
  try {
    const { fname, lname, mname, email, pw_hash, address_id, role_id = 2 } = req.body;
...
export const updateBranch = async (req, res) => {
  try {
    ...
    const { branch_name, addressline1, addressline2, city_id, is_deleted } = req.body;
...
export const updateUser = async (req, res) => {
  try {
    ...
    const { email, pw_hash, fname, lname, mname, address_id, role_id, is_deleted } = req.body;
